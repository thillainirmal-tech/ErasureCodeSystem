...
<body>
	...
	<main id="top" class="masthead" role="main">
		<div class="container">
			...
			<strong> Powerful Way  </strong> NetWork </h1>
	...
	<div class="container" id="explore">
		...
		<section class="row heroimg breath">
			<div class="col-md-12 text-center"> 
				<img src="images/newpng_deva.png" alt="flat-mockup-template">
			</div>
		</section><! --/section -->
		...
		<div class="highlight testimonials">
			<div class="container">
				...
				<section class="row breath">
					<div class="col-md-6">
						<div class="testblock">James Arthur Gosling, OC (born May 19, 1955) is a Canadian computer scientist, best known as the father of the Java programming language.[3</div>
		...
		<div class="container">
			...
			<div class="section-title">
				...
				<h4>No contract. No risk. No hacking. </h4>
			</div>
		...
		<main class="footercta" role="main">
			<div class="container">
				<h1>The Most Simple & <strong>Powerful Way</strong> <br>
					to <strong>launch</strong> your project</h1>
 
				<div class="row">
					<div class="col-md-12 breath text-center"> 
						<a href="Admin1.jsp" class="btn btn-success btn-lg gototop">GET EARLY ACCESS</a> 
					</div>
				</div>
			</div><! --/container -->
		</main><! --/main -->
		...
		<div class="container">
			<section class="row breath">
				<div class="col-md-12 footerlinks">
					<p>&copy; 2016 Pantech All Rights Reserved</p>
				</div>
			</section><! --/section -->
		</div><! --/container -->
