...
<header>
  <div class="container_12">
    <div class="grid_12">
      <h1 class="logo">
        <a href="index.html">Your    Data Has Been  Tried    By   </a>
        <br> <br> <br <br>    <br> <br> <br <br>
        
        
        <br> <br> <br <br>    <br> <br> <br <br>
        <a href="index.html">Intrudens  Contact your  Admin</a>
      </h1>
    </div>
    <div class="clear"></div>
  </div>
  ...
  <div class="container_12">
    <div class="grid_12">
      <div id="camera_wrap" class="">
        <div data-src="images1/slide-2.jpg" data-thumb="images1/thumb-1.jpg"></div>
        <div data-src="images1/slide-3.jpg" data-thumb="images1/thumb-2.jpg"></div>
        <div data-src="images1/slide-1.jpg" data-thumb="images1/thumb-3.jpg"></div>
      </div>
    </div>
    <div class="clear"></div>
  </div>
